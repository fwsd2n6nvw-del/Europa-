...
<svg id="ufoSprite" viewBox="0 0 48 64" aria-hidden="true" shape-rendering="crispEdges">
  <rect x="16" y="6" width="16" height="10" fill="#dbe7f7"/>
  <rect x="14" y="8" width="20" height="10" fill="#dbe7f7"/>
  <rect x="18" y="10" width="12" height="8" fill="#1e3557"/>

  <rect x="8" y="18" width="28" height="6" fill="#dbe7f7"/>
  <rect x="6" y="24" width="30" height="20" fill="#dbe7f7"/>
  <rect x="8" y="44" width="24" height="8" fill="#dbe7f7"/>
  <rect x="12" y="52" width="12" height="4" fill="#dbe7f7"/>

  <rect x="32" y="30" width="4" height="10" fill="#9db5d6"/>
  <rect x="28" y="40" width="4" height="8" fill="#9db5d6"/>
  <rect x="20" y="46" width="4" height="6" fill="#9db5d6"/>
  ...
  <rect x="34" y="46" width="6" height="6" fill="#dbe7f7"/>
  <rect x="36" y="48" width="6" height="6" fill="#dbe7f7"/>

  <rect x="12" y="56" width="12" height="2" fill="#90a6c6"/>
  <rect x="6" y="24" width="2" height="20" fill="#90a6c6"/>
  <rect x="8" y="18" width="28" height="2" fill="#90a6c6"/>
